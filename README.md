...
> **Product Manager | AI & SaaS | MBA@IIM Kozhikode | Engineering@KIIT**
...
### ✈️ [Departly.ai](https://github.com/abhinavathankar/Departly.ai)
**AI-Powered Air Travel & Itinerary Assistant**
*A smart travel assistant that leverages DB RAG to help users explore destinations and plan itineraries.*
- **Tech Stack:** Python, Gemini (Prompt Engineering), RAG, Google Maps API, Firebase DB.
- **Key Features:** Intelligent destination discovery and itinerary planning.

### 🍳 [BiteBot.ai](https://github.com/abhinavathankar/BiteBot.ai)
**AI-Powered Recipe Generator & Automated Shopper**
*An intelligent culinary assistant that generates recipes and creates automated shopping carts for missing ingredients.*
- **Tech Stack:** Python, Gemini (Vibe Coding), RAG, Rapid Prototyping.
- **Key Features:** Multi-modal AI delivery and automated cart creation.

### 🛍️ [Fashion E-commerce UX Analysis](https://github.com/abhinavathankar/Competitive-Analysis-Fashion-E-commerce)
...
[![Instagram](https://img.shields.io/badge/-Instagram-E4405F?style=for-the-badge)](https://www.instagram.com/doublecheesehamburger/)
